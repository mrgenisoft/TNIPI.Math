...
{
    /// <summary>
    /// This class contains all the methods and subclasses of the HarmonicAverage.
    /// Worksteps are displayed in the workflow editor.
    /// </summary>
    public class HarmonicAverage : Workstep<HarmonicAverage.Arguments>, IPresentation, IDescriptionSource
    {
        /// <summary>
        ...
        protected override void InvokeSimpleCore(Arguments argumentPackage)
        {
            ...
            Invoke_HarmonicAverage(args.Grid, args.PropertyCollection, args.OutputProperty);
        }

        private void Invoke_HarmonicAverage(Grid grid, PropertyCollection propertyCollection, Property outputProperty)
        {
            PetrelLogger.InfoOutputWindow("Invoke_HarmonicAverage start: " + DateTime.Now.ToString());
                ...
                for (int i = 0; i < grid.NumCellsIJK.I; i++)
                    for (int j = 0; j < grid.NumCellsIJK.J; j++)
                        for (int k = 0; k < grid.NumCellsIJK.K; k++)
                        {
                            ...
                            outfpi[i, j, k] = (float)(propertyCollection.PropertyCount / sum);
                        }

                trans.Commit();
            }

            PetrelLogger.InfoOutputWindow("Invoke_HarmonicAverage end: " + DateTime.Now.ToString());
        }
        ...
        /// <summary>
        /// ArgumentPackage class for HarmonicAverage.
        ...
        /// <summary>
        /// Gets the description of the HarmonicAverage
        /// </summary>
        public IDescription Description
        {
            get { return HarmonicAverageDescription.Instance; }
        }

        /// <summary>
        /// This singleton class contains the description of the HarmonicAverage.
        /// Contains Name, Shorter description and detailed description.
        /// </summary>
        public class HarmonicAverageDescription : IDescription
        {
            /// <summary>
            /// Contains the singleton instance.
            /// </summary>
            private  static HarmonicAverageDescription instance = new HarmonicAverageDescription();
            /// <summary>
            /// Gets the singleton instance of this Description class
            /// </summary>
            public static HarmonicAverageDescription Instance
            {
                get { return instance; }
            }
            ...
            /// <summary>
            /// Gets the name of HarmonicAverage
            /// </summary>
            public string Name
            {
                get { return "Harmonic mean"; }
            }
            /// <summary>
            /// Gets the short description of HarmonicAverage
            /// </summary>
            public string ShortDescription
            {
                get { return "Generate single continuous property representing harmonic mean from a range of properties."; }
            }
            /// <summary>
            /// Gets the detailed description of HarmonicAverage
            /// </summary>
