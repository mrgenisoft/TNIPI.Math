...
{
    /// <summary>
    /// This class contains all the methods and subclasses of the Sum.
    /// Worksteps are displayed in the workflow editor.
    /// </summary>
    public class Sum : Workstep<Sum.Arguments>, IPresentation, IDescriptionSource
    {
        /// <summary>
        ...
        protected override void InvokeSimpleCore(Arguments argumentPackage)
        {
            ...
            Invoke_Sum(args.Grid, args.PropertyCollection, args.OutputProperty);
        }

        private void Invoke_Sum(Grid grid, PropertyCollection propertyCollection, Property outputProperty)
        {
            PetrelLogger.InfoOutputWindow("Invoke_Sum start: " + DateTime.Now.ToString());
            ...
            PetrelLogger.InfoOutputWindow("Invoke_Sum end: " + DateTime.Now.ToString());
        }
        ...
        /// <summary>
        /// Gets the description of the Sum
        /// </summary>
        public IDescription Description
        {
            get { return SumDescription.Instance; }
        }

        /// <summary>
        /// This singleton class contains the description of the Sum.
        /// Contains Name, Shorter description and detailed description.
        /// </summary>
        public class SumDescription : IDescription
        {
            /// <summary>
            /// Contains the singleton instance.
            /// </summary>
            private  static SumDescription instance = new SumDescription();
            /// <summary>
            /// Gets the singleton instance of this Description class
            /// </summary>
            public static SumDescription Instance
            {
                get { return instance; }
            }
            ...
            /// <summary>
            /// Gets the short description of Sum
            /// </summary>
            public string ShortDescription
            {
                get { return "Generate single continuous property representing sum from a range of properties."; }
            }
            /// <summary>
            /// Gets the detailed description of Sum
            /// </summary>
