...
{
    /// <summary>
    /// This class contains all the methods and subclasses of the Minimum.
    /// Worksteps are displayed in the workflow editor.
    /// </summary>
    public class Minimum : Workstep<Minimum.Arguments>, IPresentation, IDescriptionSource
    {
        /// <summary>
        ...
        protected override void InvokeSimpleCore(Arguments argumentPackage)
        {
            ...
            Invoke_Minimum(args.Grid, args.PropertyCollection, args.OutputProperty);
        }

        private void Invoke_Minimum(Grid grid, PropertyCollection propertyCollection, Property outputProperty)
        {
            PetrelLogger.InfoOutputWindow("Invoke_Minimum start: " + DateTime.Now.ToString());
            ...
            PetrelLogger.InfoOutputWindow("Invoke_Minimum end: " + DateTime.Now.ToString());
        }
        ...
        /// <summary>
        /// ArgumentPackage class for Minimum.
        ...
        /// <summary>
        /// Gets the description of the Minimum
        /// </summary>
        public IDescription Description
        {
            get { return MinimumDescription.Instance; }
        }

        /// <summary>
        /// This singleton class contains the description of the Minimum.
        /// Contains Name, Shorter description and detailed description.
        /// </summary>
        public class MinimumDescription : IDescription
        {
            /// <summary>
            /// Contains the singleton instance.
            /// </summary>
            private  static MinimumDescription instance = new MinimumDescription();
            /// <summary>
            /// Gets the singleton instance of this Description class
            /// </summary>
            public static MinimumDescription Instance
            {
                get { return instance; }
            }
            ...
            /// <summary>
            /// Gets the short description of Minimum
            /// </summary>
            public string ShortDescription
            {
                get { return "Generate single continuous property representing minimum from a range of properties."; }
            }
            /// <summary>
            /// Gets the detailed description of Minimum
            /// </summary>
